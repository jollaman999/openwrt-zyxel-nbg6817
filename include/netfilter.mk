...
# webstr
$(eval $(call nf_add,IPT_WEBSTR,CONFIG_NETFILTER_XT_MATCH_WEBSTR, $(P_XT)xt_webstr))
...
$(eval $(call nf_add,IPT_IPOPT,CONFIG_NETFILTER_XT_MATCH_CONNLIMIT,$(P_XT)xt_connlimit))
...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,3.7.0)),1)
   ...
   $(eval $(call nf_add,IPT_NAT_EXTRA,CONFIG_IP_NF_TARGET_REDIRECT, $(P_XT)xt_REDIRECT))
else
...
$(eval $(call nf_add,IPT_PORTTRIGGER,CONFIG_IP_NF_TARGET_PORTTRIGGER, $(P_V4)ipt_PORTTRIGGER))
