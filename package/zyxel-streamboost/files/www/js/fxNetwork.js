    ...
    */
                                ...
                                pHandler)
    {
		...
		*/
        ...
        g_nWidth = m_nWidth = (self.calcWidth() - 64 );//$(window).width()-$("#L").width() - 48;
        ...
        $("#"+self.m_sDiv+" svg").css('overflow','visible');
        $("#"+self.m_sDiv+" svg").width('100%');
