...
*/
        ...
        if(bShowButtons != undefined && bShowButtons == true)
        {
            ...
            _t(" ") +
			'</pre>' +
            '<div class="priorityBox" style="padding-left:17px;">' +
            ...
            '    <button id="prSave" type="button" style="width:120px">' + _t("Save") + '</button>' +
            '    <button id="prCancel"type="button" style="width:135px">' + _t("Cancel") + '</button>' +
            '    </div>' +
            '</div>' +
            '</div>';
